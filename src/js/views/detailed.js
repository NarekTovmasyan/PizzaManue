...
<div class="card-containerDetailed">
 ...
 <div class="hamburger-menu">
    ...
    renderHamburger();
    debugger;    
    console.log('detailedLState:type=', type);
    console.log('detailedLState: ', State);
...
//               let ingredientsList = [];
//               paramsData.ingredients.forEach(function(ingredient){
//                    ingredientsList.push(`<li>${ingredient.name}</li>`);
//               });
